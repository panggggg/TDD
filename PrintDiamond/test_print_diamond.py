...
class TestPrintDiamond(unittest.TestCase):
    ...
    def test_left_and_right_space_push_charecter_A_should_be_return_list_0_space(self):
        list_left_space = [0]
        expected = list_left_space
        actual = self.diamond.print_left_and_right_space("A")
        self.assertEquals(expected, actual)

    def test_left_and_right_space_push_charecter_B_should_be_return_list_0_1(self):
        list_left_space = [0, 1]
        expected = list_left_space
        actual = self.diamond.print_left_and_right_space("B")
        self.assertEquals(expected, actual)

    def test_left_and_right_space_push_charecter_C_should_be_return_list_0_1_2(self):
        list_left_space = [0, 1, 2]
        expected = list_left_space
        actual = self.diamond.print_left_and_right_space("C")
        self.assertEquals(expected, actual)

    def test_left_and_right_space_push_charecter_D_should_be_return_list_0_1_2_3(self):
        list_left_space = [0, 1, 2, 3]
        expected = list_left_space
        actual = self.diamond.print_left_and_right_space("D")
        self.assertEquals(expected, actual)
