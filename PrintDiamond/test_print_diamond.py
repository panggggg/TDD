...
class TestPrintDiamond(unittest.TestCase):
    ...
    def test_print_diamond_push_E_line_1(self):
        expected = "....A...."
        actual = self.diamond.print_diamond(charecter="E", line=1)
        self.assertEquals(expected, actual)
    ...
    def test_print_diamond_push_C_line_2(self):
        expected = ".B.B."
        actual = self.diamond.print_diamond(charecter="C", line=2)
        self.assertEquals(expected, actual)

    def test_print_diamond_push_C_line_3(self):
        expected = "C...C"
        actual = self.diamond.print_diamond(charecter="C", line=3)
        self.assertEquals(expected, actual)
    ...
    def test_print_diamond_push_D_line_2(self):
        expected = "..B.B.."
        actual = self.diamond.print_diamond(charecter="D", line=2)
        self.assertEquals(expected, actual)

    def test_print_diamond_push_D_line_3(self):
        expected = ".C...C."
        actual = self.diamond.print_diamond(charecter="D", line=3)
        self.assertEquals(expected, actual)

    def test_print_diamond_push_D_line_4(self):
        expected = "D.....D"
        actual = self.diamond.print_diamond(charecter="D", line=4)
        self.assertEquals(expected, actual)

    def test_print_diamond_push_D_line_5(self):
        expected = ".C...C."
        actual = self.diamond.print_diamond(charecter="D", line=5)
        self.assertEquals(expected, actual)

    def test_print_diamond_push_D_line_6(self):
        expected = "..B.B.."
        actual = self.diamond.print_diamond(charecter="D", line=6)
        self.assertEquals(expected, actual)

    def test_print_diamond_push_D_line_7(self):
        expected = "...A..."
        actual = self.diamond.print_diamond(charecter="D", line=7)
        self.assertEquals(expected, actual)